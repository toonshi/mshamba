...
import Canister "mo:base/Canister";
...
actor {
  ...
  public shared ({ caller }) func createFarmLedger(
    ...
    let archiveInitArg = Candid.encode("(principal, nat64, opt nat64, opt nat64)", (selfPrincipal, 2000, ?1000, ?4_000_000_000_000)); // trigger_threshold, num_blocks_to_archive, cycles_for_archive_creation
