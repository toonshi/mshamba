      ...
      try {
        ...
        const processedFarms = backendFarms.map(farm => {
          ...
          return {
            ...
            targetAmount: farm.fundingGoal != null ? Number(farm.fundingGoal) : dummyFarm.targetAmount,
            currentAmount: farm.fundedAmount != null ? Number(farm.fundedAmount) : dummyFarm.currentAmount,
