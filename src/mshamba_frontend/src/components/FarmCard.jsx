...
export const FarmCardLight = ({ farm, onInvest, hasWallet }) => {
  const IconComponent = farm.icon;

  return (
    <div className="bg-orange-50 rounded-xl overflow-hidden hover:bg-orange-100 transition-colors shadow-md">
      <div className="h-48 bg-cover bg-center" style={{ backgroundImage: `url(${farm.image})` }}>
        <div className="h-full bg-white bg-opacity-30 flex items-end p-4">
          <div className="flex items-center space-x-3">
            <div className={`w-10 h-10 ${farm.color} rounded-lg flex items-center justify-center`}>
              <IconComponent className="w-5 h-5 text-white" />
            </div>
      ...
      <div className="p-4">
        <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
          <div>
            ...
            <div className="font-medium text-gray-700">{farm.size}</div>
          </div>
          <div>
            <div className="text-gray-500">Crop Type</div>
            <div className="font-medium text-gray-700">{farm.crop}</div>
          </div>
          <div>
            <div className="text-gray-500">24h &chg</div>
            <div className="font-medium text-green-600">{farm.expectedReturn}</div>
          </div>
          <div>
            <div className="text-gray-500">Duration</div>
            <div className="font-medium text-gray-700">{farm.duration}</div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <div className="font-bold text-lg text-gray-800">{farm.minInvestment}</div>
          </div>
          <div className="text-right">
            <div className="text-gray-500 text-sm">Farmer</div>
            <div className="font-medium text-gray-800">{farm.farmer}</div>
          </div>
        </div>
